...
export default function Home() {
  ...
  return (
    <>
      ...
      <footer className="fixed bottom-2 left-1/2 z-10 flex w-11/12 -translate-x-1/2 transform items-center justify-around gap-4 rounded-3xl bg-zinc-800 p-4 shadow-lg sm:w-1/2 lg:w-[40%]">
        ...
        >
          <svg className="h-7 w-7" stroke="currentColor" fill="currentColor" viewBox="0 0 496 512">
